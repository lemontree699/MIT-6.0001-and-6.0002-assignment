...
# make_one_curve_plot(range(300), pop_avg, 'Timestep', 'Average Population', 'Without Antibiotic')
...
# populations = simulation_without_antibiotic(100, 1000, 0.1, 0.025, 50)
# print(r"the 95% confidence interval:", calc_95_ci(populations, 299))
...
# pop_avg_resi = []
# for i in range(400):
#     pop_avg.append(calc_pop_avg(total_pop, i))
#     pop_avg_resi.append(calc_pop_avg(resistant_pop, i))
# make_two_curve_plot(range(400), pop_avg, pop_avg_resi, 'Total', 'Resistant', 'Timestep', 'Average Population', 'With an Antibiotic')

# print(r"the 95% confidence interval for the total population estimate:", calc_95_ci(total_pop, 299))
# print(r"the 95% confidence interval for the resistant bacteria estimate:", calc_95_ci(resistant_pop, 299))