...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    # 可视化
    # anim = ps3_visualize.RobotVisualization(num_robots, width, height, False, delay = 0.1)
...
#       of a 20x20 room?
#  两种不同的机器人类型分别清扫相同的房间，当机器人的数量增加时，
#  他们所用的步数都有减少，且在机器人数目相同的情况下，FaultRobot的步数总多于StandardRobot
#
# 2) How does the performance of the two robot types compare when two of each
#       robot cleans 80% of rooms with dimensions 
#       10x30, 20x15, 25x12, and 50x6?
#  两种不同的机器人分别清扫固定瓷砖数的房间，但是长宽比例不同，
#  当长宽比增加时，两种机器人运行的步数都是先减少再增加，长宽比大概为1.4时到达最低，
#  但StandardRobot所用步数明显少于FaultRobot，且跟随长宽比增加，
#  FaultRobot所用步数增长的幅度也更大
#  
#
